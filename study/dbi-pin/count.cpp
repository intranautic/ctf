// counts the number of instructions process executes
#include <stdio.h>
#include "pin.H"

KNOB<std::string> log_file(KNOB_MODE_WRITEONCE, "pintool", "o", "count.log", "output file name");
...
int main(int argc, char** argv) {
  ...
  if (PIN_Init(argc, argv)) {
    fprintf(stderr, "This tool counts the number of instructions the binary executes\n%s",
